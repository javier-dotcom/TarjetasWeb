...
$consulta="SELECT * from eventos WHERE id = 5";
...
<body>
  ...
  <nav class="navbar  fixed-top">
    <div class="container-fluid">
      ...
      <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel"
        style="background-image:url('img/Bianca2.png'); background-size:cover; background-repeat: no-repeat; background-position: center;">


        <div class="offcanvas-header">
          <h5 class="offcanvas-title" id="offcanvasNavbarLabel">BIANCA</h5>
  ...
  <div class="background-image">
    <div class="content-container">
      ...
      <h1 class="teEspero"><span>Bianca</span></h1>
      ...
      <div class="slider">
        <div class="slide-track">
          <div class="slide">
            <img src="img/Bianca1.png" height="100" width="250" alt="">
          </div>
          <div class="slide">
            <img src="img/Bianca2.png" height="100" width="250" alt="">
          </div>
          <div class="slide">
            <img src="img/Bianca3.png" height="100" width="250" alt="">
          </div>
          <div class="slide">
            <img src="img/Bianca4.png" height="100" width="250" alt="">
          </div>
          <div class="slide">
            <img src="img/Bianca5.png" height="100" width="250" alt="">
          </div>
          <div class="slide">
            <img src="img/Bianca1.png" height="100" width="250" alt="">
          </div>
      ...
      <div class="container-2">
        <div class="image-container-2">
          <img src="img/fondo14.png" alt="Imagen 2" class="image-2">
          <p class="image-caption">"¡Hola ! Estoy emocionada de celebrar mi cumpleaños y
            quiero que ustedes sean parte de esta ocasión especial. Los invito a compartir 
            alegría y momentos inolvidables en mi fiesta. ¡No se lo pierdan! ¡Los espero con ansias
            para celebrar juntos mi día especial! Podes confirmar asistencia aqui abajo" <br>
    ...
    <div class="image-container">
        ...
        <div class="container-2">
          <div class="image-container-2">
            <img src="img/fondo14.png" alt="Imagen 2" class="image-2">
            <p class="image-caption">"¡Tu presencia hace de este día algo muy especial! Por favor, deja un mensaje para Bianca
               y comparte tus mejores deseos y recuerdos. Nos encantaría saber cómo Bianca ha tocado tu vida y qué momentos
                especiales has compartido con ella.
               ¡Gracias por ser parte de esta celebración tan importante y hacerla aún más memorable!"
            </p>
        ...
        <div class="container">
          <div class="image-container">
         <img src=<?php echo $imagen1?> alt="Imagen 1" class="image left ">
          </div>
        </div>
        <br>
      <div class="container-2">
        <div class="image-container-2">
          <img src="img/fondo14.png" alt="Imagen 2" class="image-2">
          <p class="image-caption">"¡ Para hacer mi cumple aún más divertido, 
            me encantaría que elijan una canción especial para que podamos disfrutar juntos en la fiesta. 
            ¡Será genial compartir nuestros temas favoritos! Espero verlos allí y 
            bailar al ritmo de su selección musical. No olviden 
            dejar su canción elegida aquí abajo.". <img src="img/play.png" width="50px" alt=""></p>
      ...
      <div class="container">
        <div class="image-container">
          <img src=<?php echo $imagen1?> alt="Imagen 1" class="image right ">
        </div>
      </div>
      <br>
      <div class="accordion accordion-flush" id="accordionFlushExample">
        ...
        <div class="container">
          <div class="image-container">
            <img src="https://drive.google.com/thumbnail?id=1CblJ1bze0itLcKBdjRLgA3AgmYxUfEDY" alt="Imagen 1" class="image left ">
          </div>
        </div>
        <br>
        <div class="accordion-item">
